...
public class CalculatorTest {
    ...
    private void print(String methodName,String actual,String expected){
    	 System.out.println("method:"+methodName+"	actual:" + actual + "	expected:" + expected);
    }
  ...
  //@Test 标准的方法，返回值必须是void，而且无参数
    ...
    public void testAdd() {
       ...
       this.print("add", "5", calculator.getResult()+"");
    }
    ...
    public void testSubstract() {
        ...
        this.print("substract11", "8", calculator.getResult()+"");
        assertEquals(8,calculator.getResult());
        
        this.print("substract", "8", calculator.getResult()+"");
    }
    ...
    public void testMultiply() {  
        ...
        this.print("multiply", "6", calculator.getResult()+"");
    }
    ...
    public void testDivide() {
         ...
         this.print("divide", "4", calculator.getResult()+"");
    }
     ...
     * */
     ...
     public void squareRoot() {
            ...
            this.print("squareRoot", "2", calculator.getResult()+"");
        }
     ...
     @Test(expected = ArithmeticException.class)
      public void divideByZero() {
         ...
         this.print("divide", "-1", calculator.getResult()+"");
         }
}
